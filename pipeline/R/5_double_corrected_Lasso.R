...
res_Lasso <- double_corrected_Lasso(id_exposure = id_exposure,id.list = id.list,
                                    df_info = df_info,mvdat_x = mvdat_x,mvdat_y = mvdat_y,
                                    radius_type=radius_type,seed = seed, maxits = maxits)
