...
- Use [Download Directory](https://download-directory.github.io/). Just copy 
address link https://github.com/YuxiaoRuoyao/mrScan/tree/master/pipeline and download.  
...
Note the pvalue column content could be NA if the data does not have pvalue. If the local file 
is downloaded from IEU Open GWAS database or EBI database (harmonized one), you can 
just write NA for snp, beta_hat, se and p_value column and don't need to check the 
exact column name. But you must need to provide snp, beta_hat and se column names if 
it's a flat file because we don't know your own data structure in advance.
