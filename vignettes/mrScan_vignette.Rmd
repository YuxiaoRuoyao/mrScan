...
library(rlang)
library(purrr)
format_combine(id_list = c("ieu-b-42","ieu-b-35","ukb-b-19953"),
               file_list = c("ieu-b-42.vcf.gz","ieu-b-35.vcf.gz","ukb-b-19953.vcf.gz"),
               out_dir="data/",prefix="test2")
```
...
```{r}
ld_prune_chrom_plink(zmat_dir = "data/",prefix = "test2",ref_path = "/path/LD_reference/EUR",
                     out_dir = "/path/ld_prune_output/")
```

### 4. Calculate R correlation matrix
```{r}
ldsc_full(l2_dir,zmat_dir = "data/",prefix = "test2",out_dir = "data/")
```
...
res_grapple_R <- MVMR_analysis_local(ld_prune_file_dir = "/path/ld_prune_output/",
                    prefix = "test2",R = "data/test2.R_est.RDS",
